...
class reservaQuadras():
    
    def __init__(self):
        self.reservas = []


    def verif_conflito(self, hora_inic, hora_fim):
    ...
    def fazer_reserva(self,):
        while True:
            ...
            if (min_h > hora_inic) or (hora_fim >= max_h) or (hora_inic >= hora_fim):
                ...
                break
            if self.verif_conflito(hora_inic, hora_fim):
            ...
            self.reservas.append((hora_inic, hora_fim))
